...
function Footer() {
  return (
    <div className="bg-gray-100 flex flex-col">
      ...
      <div className=" px-20 flex md:flex-row flex-col items-center justify-between mb-10">
        ...
        <div className="flex flex-col p-4 m-4 item-center ">
          ...
          <div className="flex flex-row text-gray-500">
            <FaFacebookSquare className="w-5 h-5" fill="#379e5d" />
            <p className="px-2">facebook</p>
          </div>
          <div className="flex flex-row text-gray-500">
            <FaInstagramSquare className="w-5 h-5" fill="#379e5d" />
